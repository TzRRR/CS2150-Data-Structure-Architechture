 ...
 *
 * @param first The first string vector to iterate through
 * @param second The second string vector to iterate through.
 * @param g The Mersenne Twister engine object
 * @todo
 */
...
/**
 * @brief Constructor of Middle-Earth object
 *
 * Count the number of cities in the array, copy all the cities into a mutable vector,
 * compute random city positions using parameter xsize and ysize, and then compute
 * the 2-d distance array
 * @param xsize The integer used to compute the xposition of a given city
 * @param ysize The integer used to compute the yposition of a given city
 * @param num_cities Number of cities
 * @param seed The integer used in random number generater
 * @sa middleearth
 * @todo
 */
 ...
 *
 * Prints out info about all cities in the array
 * @todo
 */
...
/**
 * @brief Calculate the distance between two passed cities
 *
 * @return The distance between the two passed cities.
 * @param city1 The name of the first city passed in
 * @param city2 The name of the second city passed in
 * @todo
 */
...
/**
 * @brief Provide the list of cities to travel to given a number of destinations
 *
 * @return The list of cities to travel to.
 * @param length The number of cities passed during travelling
 * @todo
 */
