...
/**
 * @brief Sort input topologically and print the result
 *
 * This function takes input from a file ,stores them in a map, performs a topological sort, and print the result
 *
 * @return The default value 0
 * @param argc The number of arguments
 * @param argv The array that contains all arguments
 */
