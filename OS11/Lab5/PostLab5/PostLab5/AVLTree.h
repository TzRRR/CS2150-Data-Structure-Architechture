// Tianze Ren, tr2bx, 10/14/2022, AVLTree.h
#ifndef AVL_H
#define AVL_H
...
private:
    ...
    AVLNode* remove(AVLNode*& n, string& x);
    ...
    void inserth(AVLNode*& n, string& x);
    
    bool findh(AVLNode*& n, const string& x) const;
    
    int numNodesh(AVLNode*& n);
    
    string pathToh(string output, AVLNode*& n, const string& x);
